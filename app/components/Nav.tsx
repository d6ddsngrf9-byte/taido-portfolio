...
export default function Nav({ activeLink }: NavProps) {
  ...
  return (
    <>
      <nav style={{ background: bg, position: "fixed", top: 0, left: 0, right: 0, zIndex: 50 }}
        className="px-6 md:px-10 h-20 flex items-center justify-between">

        <Link href="/">
          <img src="/logo.svg" alt="taido.design" style={{ height: "35px", filter: "brightness(0) invert(1)" }} />
        </Link>
        ...
        >
          {open ? (
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              <line x1="2" y1="2" x2="16" y2="16" stroke="rgba(255,255,255,0.8)" strokeWidth="1.2"/>
              <line x1="16" y1="2" x2="2" y2="16" stroke="rgba(255,255,255,0.8)" strokeWidth="1.2"/>
            </svg>
          ) : (
            <svg width="20" height="14" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
              <line x1="0" y1="1" x2="20" y2="1" stroke="rgba(255,255,255,0.8)" strokeWidth="1.2"/>
              <line x1="0" y1="7" x2="20" y2="7" stroke="rgba(255,255,255,0.8)" strokeWidth="1.2"/>
              <line x1="0" y1="13" x2="20" y2="13" stroke="rgba(255,255,255,0.8)" strokeWidth="1.2"/>
            </svg>
          )}
        </button>
        ...
        {open && (
          <div className="md:hidden absolute top-full left-0 right-0 z-50 flex flex-col gap-0"
            style={{ background: bg, borderTop: "1px solid rgba(255,255,255,0.1)" }}>
            {[
